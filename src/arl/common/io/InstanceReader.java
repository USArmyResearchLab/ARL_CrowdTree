...
public interface InstanceReader<I extends Object> extends Initializable {
	
	/**
	 * Return an Instance read using the given reader. If no Instance is left
	 * to be read, null is returned.
	 */	
	I readInstance() throws InstanceReadException;
