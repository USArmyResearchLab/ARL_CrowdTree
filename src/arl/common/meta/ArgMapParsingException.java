...
public class ArgMapParsingException extends Exception {
	
	private static final long serialVersionUID = 1L;

	public ArgMapParsingException() {
		
	}
	
	public ArgMapParsingException(String message) {
		super(message);
	}
	
	public ArgMapParsingException(Throwable cause) {
		super(cause);
	}
